...
export default({
    name:"longitud",
     data(){return{
            entrada_numero:"",
            conversiones_gramos:{   "mm":1000,"cm":100,"dm":10,"m":1,"dam":0.1,"hm":0.01,"km":0.001, "ft":3.2808,"in":39.3701,"yd":1.0936,"nmi":0.00053996},    
            salida: "",
            toRate: "km",
            fromRate:"m"
        }},
...
<style>
.nuevoB {
	background-color: rgb(97, 158, 212);
...
.nuevo2 {
	...
	padding: 15px;
	border-radius: 5px;
	background-color: rgba(228, 51, 169, 0.472);
	color: rgb(0, 0, 0);
}
...
.nuevo3 {
	...
	padding: 15px;
	border-radius: 5px;
	background-color: rgba(180, 110, 43, 0.472);
	color: rgb(0, 0, 0);
}
